 ...
 */
function gavias_upco_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['#attached']['library'][] = 'gavias_upco/gavias-upco-admin';  
  ...
  $form['footer']['footer_skin'] = array(
    '#type' => 'select',
    '#title' => t('Setting Footer Skin'),
    '#default_value' => theme_get_setting('footer_skin'),
    '#group' => 'footer',
    '#options' => array(
      ''            => t('Default'),
      'footer-v2'   => t('Light Skin'),
    ),
  );
