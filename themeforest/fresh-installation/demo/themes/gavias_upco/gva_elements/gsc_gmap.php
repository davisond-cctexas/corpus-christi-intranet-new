...
if(!class_exists('gsc_gmap')):
   class gsc_gmap{
      ...
      <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'gavias_upco')) ?>/vendor/gmap3.js"></script>
      <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'gavias_upco')) ?>/vendor/jquery.ui.map.min.js"></script>
