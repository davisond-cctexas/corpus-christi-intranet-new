<?php
function gavias_upco_base_url(){
  global $base_url;
  $theme_path = drupal_get_path('theme', 'gavias_upco');
  return $base_url . '/' . $theme_path . '/';
}

function gavias_upco_preprocess_node(&$variables) {
  ...
  $variables['theme_uri'] = base_path() . drupal_get_path('theme', 'gavias_upco');
}

function gavias_upco_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function gavias_upco_preprocess_node__event(&$variables){
  $node = $variables['node'];
  $event_date = array();
...
function gavias_upco_preprocess_breadcrumb(&$variables){
